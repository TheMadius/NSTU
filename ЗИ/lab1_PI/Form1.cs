...
namespace lab1_PI
{
    public partial class Form1 : Form
    {
        ...
        Char[] alf = { 'а', 'б', 'в', 'г', 'д', 'е', 'ж', 'з', 'и', 'к', 'л', 'м', 'н', 'о', 'п', 'р', 'с', 'т', 'у', 'ф', 'х', 'ц', 'ч', 'ш', 'щ', 'э', 'ю', 'я', 'ь', 'ъ' };
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                int keyi = Array.IndexOf(alf, key[i % key.Length]) + 1;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < text.Length; ++i)
            {
                byte keyi = Convert.ToByte(key[i % key.Length] + 1);
                byte texti = text[i];
