...
{
	public:
        static uint8_t CRC8__get_code(std::string data_last);
        static uint8_t CRC8__table(std::string data_last);
        static uint16_t CRC16__table(std::string data_last);
        static std::string CRC__get(std::string data, std::string code);
        static std::string CRC__remainder(std::string data, std::string code);
        static std::string byteToStr(uint8_t data);
        static std::string byteToStr(uint16_t data);
        static uint8_t StrToByte8(std::string str);
        static std::string StrTo2Char(std::string str);
        static uint16_t StrToByte16(std::string str);
};
